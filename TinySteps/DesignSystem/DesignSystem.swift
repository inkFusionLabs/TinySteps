...
extension DesignSystem {
    ...
    struct iPadOptimization {
        ...
        // MARK: - Enhanced iPad Navigation View
        struct iPadNavigationView<Content: View>: View {
            let content: Content
            let isIPad: Bool
        ...
        // MARK: - Enhanced iPad Sidebar View
            ...
            var body: some View {
                List {
                    ...
                    Section("Care & Journal") {
                        ...
                        NavigationLink(destination: EmptyView()) {
                            Label("NICU Info", systemImage: "stethoscope")
                        }
                    }
